...
b = -0.15
ball.a= vector(0, -9.8, 0)+ b*ball.v  #vector for acceleration of ball
...
while ball.pos.y >= 0.0:  #loop to do the following indented code over and over until t > tend 
     ...
     rate(50)   #executes code only at 1000Hz (slows the motion enough to be seen) 
     ...
     ball.a = vector(0, -9.8,0) + b*ball.v
     aarrow.axis = ball.a
